                                ...
                                <div id="bootstrap-wizard-1" class="col-sm-12">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab1">
                                            <br>
                                            <h3><strong></strong></h3>
                                        <?php if($permisos[12][USUARIOS::$LEER]){ ?>
																					<div class="row">
                                        ...
                                        <div class="tab-pane " id="tab2">
                                            <br>
                                            <h3><strong></strong></h3>
                                        <?php if($permisos[13][USUARIOS::$LEER]){ ?>
																				<div class="panel panel-default">
																					<div class="panel-heading">
																					</div>
																					<div class="panel-body">
                                        ...
                                        <div class="tab-pane " id="tab3">
                                            <br>
                                            <h3><strong></strong></h3>
                                        <?php if($permisos[14][USUARIOS::$LEER]){ ?>
																				<div class="panel panel-default">
																					<div class="panel-heading">
																					</div>
																					<div class="panel-body">
                                        ...
                                        <?php if($permisos[15][USUARIOS::$LEER]){ ?>
	                                            ...
	                                            <div class="col-sm-6">
		                                            <button  id="btnConstancia" type="button" class="btn btn-primary  active">Guardar Constancia de Relotificación</button>
	                                            </div>
																						</div>
																					</div>
																				</div>
...
\$(document).ready(function() {
			...
			\$('#btnConstancia').click(function() {
                  ...
                  if (!\$valid) {
                    ...
                    var datos = \$('#wizard-1').serializeArray().reduce(function(obj, item) {
                                                            if(item.name =='id' )
                                                                form_data.append('TramiteRelotificacion['+item.name +']',item.value);
                                                            return obj;
                                                        }, {});
                    ...
                    \$.ajax({
                                url: '".Yii::$app->homeUrl."/tramite-relotificacion/salvar', // point to server-side PHP script 
            ...
            \$('#btnGuardarRevision').click(function() {
                    ...
                    \$.ajax({
                                url: '".Yii::$app->homeUrl."//tramite-relotificacion/atras', // point to server-side PHP script 
                                dataType: 'json',  // what to expect back from the PHP script, if anything
                                cache: false,
                                contentType: false,
                                processData: false,
            ...
            //Bootstrap Wizard Validations
              ...
              var \$validator = \$('#wizard-1').validate({
                ...
                p1DescriProceso: {
                  ...
                  maxlength: 'El Valor de {$model->getAttributeLabel('p1DescriProceso')} excede el número de caracteres permitidos',
                ...
                p1FirmaSolicitante: {
                  ...
                  maxlength: 'El Valor de {$model->getAttributeLabel('p1FirmaSolicitante')} excede el número de caracteres permitidos',
                ...
                p1FirmaPropietarios: {
                  ...
                  maxlength: 'El Valor de {$model->getAttributeLabel('p1FirmaPropietarios')} excede el número de caracteres permitidos',
                ...
                p4ObservacionesSupervisor: {
                  ...
                  maxlength: 'El Valor de {$model->getAttributeLabel('p4ObservacionesSupervisor')} excede el número de caracteres permitidos',
                  ...
                  if (!\$valid) {
                    ...
                    \$.ajax({
                                ...
                                success: function(data){
                                            ...
                                            if(data.p2PropuestaRelotificacion){
