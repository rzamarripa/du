                                ...
                                <div id="bootstrap-wizard-1" class="col-sm-12">
                                    <div class="form-bootstrapWizard">
                                        <ul class="bootstrapWizard form-wizard">
                                            ...
                                            <li   data-target="#step3" style="width:14.285714285714%">
                                                <a id="btntab3" href="#tab3" data-toggle="tab" disabled="disabled"> <span class="step">3</span> <span class="title">Asignación de Numero</span> </a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane " id="tab3">
                                            <br>
                                            <h3><strong>Paso 3 </strong> - Asignación de Numero</h3>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <?= $form->field($model,'p5Resolutivo')->checkbox([
                                                                                                            'name'=>'p5Resolutivo',
                                                                                                            'id'=>'p5Resolutivo'
                                                    ]); ?>                                                   <a href='javascript:void(0);' id='verp5Resolutivo' >ver</a> 
                                                </div>
                                            </div>
                                        <?php } else {?> 
                                            <h2 class="bg-danger"> Permiso Denegado</h2>
                                        ...
                                        <div class="tab-pane " id="tab6">
                                            <br>
                                            <h3><strong>Paso 6 </strong> - Numero Oficial</h3>
                                        <?php if($permisos[1050][USUARIOS::$LEER]){ ?>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <?php if(!$model->isNewRecord): ?>
                                                            <a href='javascript:void(0);' id='verp6NumeroOficial' >ver</a>
                                                        <?php endif; ?>                                                </div>
                                            </div>
                                        <?php } else {?> 
                                            <h2 class="bg-danger"> Permiso Denegado</h2>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group ">
               ...
               <?= Html::dropDownList('pasoatras', null,[1=>'Paso 1: Solicitud',2=>'Paso 2: Documentos',3=>'Paso 3: Asignación de Numero',4=>'Paso 4: Resolutivo',5=>'Paso 5: Revision',6=>'Paso 6: Numero Oficial',7=>'Paso 7: Archivo',], ['prompt' => '--- Seleccionar Paso ---','id'=>'pasoatras']) ?>            </div>
        </div>
     </div>
...
\$(document).ready(function() {
            ...
            \$('#verp5Resolutivo').click(function() {
                \$('#dialog_simple').dialog('open');
                \$('#dialog_simple').dialog('option', 'title', '{$model->getAttributeLabel('p5Resolutivo')}');
                \$('#dialog_simple').html('<object type=\"application/pdf\" data=\"{$basepath}/'+\$('#p5Resolutivo').attr('value')+'\" width=\"100%\" height=\"500\">Sin Informacion</object>');
                return false;
            });
            ...
            \$('#verp6NumeroOficial').click(function() {
                \$('#dialog_simple').dialog('open');
                \$('#dialog_simple').dialog('option', 'title', '{$model->getAttributeLabel('p6NumeroOficial')}');
                \$('#dialog_simple').html('<object type=\"application/pdf\" data=\"{$basepath}/'+\$('#p6NumeroOficial').attr('value')+'\" width=\"100%\" height=\"500\">Sin Informacion</object>');
                return false;
            });
            ...
            //Bootstrap Wizard Validations
              ...
              var \$validator = \$('#wizard-1').validate({
                ...
                p3Nombre: {
                  ...
                  maxlength: 'El Valor de {$model->getAttributeLabel('p3Nombre')} excede el numero de caracteres permitidos',
                ...
                p3NumeroAsignado: {
                  ...
                  maxlength: 'El Valor de {$model->getAttributeLabel('p3NumeroAsignado')} excede el numero de caracteres permitidos',
