                                ...
                                <div id="bootstrap-wizard-1" class="col-sm-12">
                                    <div class="form-bootstrapWizard">
                                        <ul class="bootstrapWizard form-wizard">
                                            ...
                                            <li   data-target="#step5" style="width:16.666666666667%">
                                                <a id="btntab5" href="#tab5" data-toggle="tab" disabled="disabled"> <span class="step">5</span> <span class="title">Supervision</span> </a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane " id="tab5">
                                            <br>
                                            <h3><strong>Paso 5 </strong> - Supervision</h3>
                                        <?php if($permisos[34][USUARIOS::$LEER]){ ?>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <?= $form->field($model,'p5ObservacionesTemporal')->checkbox([
                                                                                                            'name'=>'p5ObservacionesTemporal',
                                                                                                            'id'=>'p5ObservacionesTemporal'
                                                    ]); ?>                                                   <a href='javascript:void(0);' id='verp5ObservacionesTemporal' >ver</a> 
                                                </div>
                                            </div>
                                        <?php } else {?> 
                                            <h2 class="bg-danger"> Permiso Denegado</h2>
...
\$(document).ready(function() {
            ...
            \$('#verp5ObservacionesTemporal').click(function() {
                \$('#dialog_simple').dialog('open');
                \$('#dialog_simple').dialog('option', 'title', '{$model->getAttributeLabel('p5ObservacionesTemporal')}');
                \$('#dialog_simple').html('<object type=\"application/pdf\" data=\"{$basepath}/'+\$('#p5ObservacionesTemporal').attr('value')+'\" width=\"100%\" height=\"500\">Sin Informacion</object>');
                return false;
            });
            ...
            //Bootstrap Wizard Validations
              ...
              var \$validator = \$('#wizard-1').validate({
                ...
                p4UbicacionTemporal: {
                  ...
                  minlength: 'El Valor de {$model->getAttributeLabel('p4UbicacionTemporal')} debe contener al menos 1 caracter ',
                  maxlength: 'El Valor de {$model->getAttributeLabel('p4UbicacionTemporal')} excede el numero de caracteres permitidos',
