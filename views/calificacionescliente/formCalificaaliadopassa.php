...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" style="">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			...
			<?php $form = ActiveForm::begin(['id' => 'my-form', 'options'=>['class'=>'smart-form'], 'action'=>['calificacionescliente/calificaaliadopassa']]); ?>
				<header>
				...
				<fieldset>
					<div class="col-sm-12 col-md-6 col-lg-3 ">
						<section>
							...
							<label class="input">
								<select name="parametros[codigoCliente]" id="category" style="width:99%" class="select2min4" >
									<option></option>
						...
						<section>
							...
							<label class="input">
								<select name="parametros[cod_agricola]" id="subcategory" style="width:99%" class="select2">
						...
						<section>
							<div class="col-lg-4">
								<label>
									<input type="radio" name="parametros[tipoutilidad]" checked="checked" value="1">
									<i data-swchon-text="Si" data-swchoff-text="No"></i>Utilidad operativa
								</label>
							</div>
							<div class="col-lg-4">
								<label>
									<input type="radio" name="parametros[tipoutilidad]" value="2">
									<i data-swchon-text="Si" data-swchoff-text="No"></i>Utilidad bruta
								</label>
							</div>
						</section>
						<section>
