...
<div class="Visitas-Lugares-form">
  ...
  if($boton){ ?>
   <div class="form-group">
      <?= Html::a('Imprimir Contenido',['visitas-lugares/imprimir-filtro','fechas' => $_GET],['class'=>'btn btn-default','target' => '_blank']) ?>   
     </div>
     <?php }?>
  	...
  	<table id="datatable" class="table table-striped table-bordered">
        ...
        <tr>
          ...
          <td>
            ...
            <?= Html::a('<span class="fa fa-eye"></span>',['visitas-lugares/view','id'=>$vl->id],['class'=>'btn btn-default']) ?>
            <div class="btn-group">
