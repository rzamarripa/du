  ...
  <div class="panel-body">
		<TABLE BORDER>
			...
			<TR>
			  ...
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1DescripcionProceso')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1DescripcionProceso ?></td>
			</TR>
			<TR>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		<table class="table table-stripped table-condensed">
		  ...
		  <tr>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1CallePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1CallePredio ?></td>
			  <td width="100px"><label><strong>COLINDANCIAS:</strong></label></td>
			  <td width="100px"></td>								  
		  </tr>
		  <tr>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1ColoniaPredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1ColoniaPredio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1SuperficiePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1SuperficiePredio ?></td>
		  </tr>
		  <tr>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1NumeroOficial')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1NumeroOficial ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1NortePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1NortePredio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1NorOrientePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1NorOrientePredio ?></td>
		  </tr>
		  <tr>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1NumeroInterio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1NumeroInterio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1SurPredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1SurPredio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1SurOrientePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1SurOrientePredio ?></td>
		  </tr>
		  <tr>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1PobladoPredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1PobladoPredio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1OrientePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1OrientePredio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1NorPonientePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1NorPonientePredio ?></td>
		  </tr>				  
		  <tr>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1SindicaturaPredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1SindicaturaPredio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1PonientePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1PonientePredio ?></td>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1SurPonientePredio')?>:</strong></label></td>
			  <td width="100px"><?= $model->p1SurPonientePredio ?></td>
		  </tr>
		  <tr>
			  <td width="100px"><label><strong><?= $model->getAttributeLabel('p1ClaveCatastralPredio')?>:</strong></label></td>
