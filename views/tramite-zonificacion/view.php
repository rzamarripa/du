...
//$this->title = "Constancia de Zonificación: " . $model->p1NombreSolicitante;
...
<div class="tramite-zonificacion-view">
    ...
    <p>
        ...
        <?= Html::a('Imprimir', ['tramite-zonificacion/imprimir', 'id' => $model->id], ['class' => 'btn btn-primary', "target" => "_blank"]) ?>
    </p>
