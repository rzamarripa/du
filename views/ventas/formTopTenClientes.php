...
<div ng-controller="Toptenclientes" class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" style="">
	<!-- widget options:
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			...
			<?php $form = ActiveForm::begin(['id' => 'my-form', 'action'=>['ventas/toptenclientes'], 'options'=>['class'=>'smart-form']]); ?>
				<header>
