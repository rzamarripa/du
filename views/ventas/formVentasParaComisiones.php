...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" style="">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			...
			<?php $form = ActiveForm::begin(['id' => 'my-form', 'action'=>['ventas/ventasparacomisiones'], 'options'=>['class'=>'smart-form']]); ?>
				<header>
				...
				<fieldset>
					<div class="col-sm-12 col-md-6 col-lg-3 ">
						<section>
							...
							<label class="input">
								<select id="cliente_id" name="parametros[cod_cte]" style="width:99%" onchange="changeCliente(this)">
									<option></option>
								</select>
							</label>						
						</section>
						...
						<section>
							...
							<label class="input">
								<select id="cod_agricola" name="parametros[cod_agricola]" style="width:99%" class="select2">
									<option></option>							
								</select>
							</label>						
						</section>
						...
						<section>
							...
							<label class="input">
								<select id="grupoProductos_id" name="parametros[cod_grupo_prod_interes]" style="width:99%" class="select2">
									<option></option>
					...
					<div class="col-sm-12 col-md-3 col-lg-3">
						...
						<section>
							<label class="label">Utilidad de productos mínima(%)</label>
							<label class="input"  style="height: 28px;">
								<input type="text" name="parametros[utilidad_maxima]" maxlength="3" value="30" style="width:99%">
							</label>
						</section>
						<section>
...
<script type="text/javascript">
	...
	function changeCliente (objDropDown){    	
