                                                ...
                                                <div id="bootstrap-wizard-1" class="col-sm-12">
                                                    <div class="form-bootstrapWizard">
                                                        <ul class="bootstrapWizard form-wizard">
                                                            <li class="active"  data-target="#step1">
                                                                <a href="#tab1" data-toggle="tab"> <span class="step">1</span> <span class="title">paso1</span> </a>
                                                            </li>
                                                            <li   data-target="#step2">
                                                                <a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title">paso2</span> </a>
                                                            </li>
                                                            <li   data-target="#step3">
                                                                <a href="#tab3" data-toggle="tab"> <span class="step">3</span> <span class="title">paso3</span> </a>
                                                            </li>
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tab1">
                                                            <br>
                                                            <h3><strong>Paso 1 </strong> - paso1</h3>
                                                        ...
                                                        <div class="tab-pane " id="tab2">
                                                            <br>
                                                            <h3><strong>Paso 2 </strong> - paso2</h3>
                                                        ...
                                                        <div class="tab-pane " id="tab3">
                                                            <br>
                                                            <h3><strong>Paso 3 </strong> - paso3</h3>
                ...
                'onNext': function (tab, navigation, index) {
                  ...
                  if (!\$valid) {
                    ...
                    var datos = \$('#wizard-1').serializeArray().reduce(function(obj, item) {
                                                            ...
                                                            obj['Entregable['+item.name +']'] = item.value;
                                                            return obj;
                                                        }, {});
                    datos['paso']=index;
                    datos['_csrf']=csrfToken;
                    
                    \$.post( '".Yii::$app->homeUrl."/entregable/salvar', datos)
                                        .done(function( data ) {
