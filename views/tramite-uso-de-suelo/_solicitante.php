        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
              <table class="table table-stripped table-condensed">    
                ...
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2ProyectoArquitectonico')?>:</strong></label></td>
                    <td><?= $model->p2ProyectoArquitectonico ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2ImpactoAmbiental')?>:</strong></label></td>
                    <td><?= $model->p2ImpactoAmbiental ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2ImpactoVial')?>:</strong></label></td>
                    <td><?= $model->p2ImpactoVial ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2OpinionBomberos')?>:</strong></label></td>
                    <td><?= $model->p2OpinionBomberos ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2ProteccionCivil')?>:</strong></label></td>
                    <td><?= $model->p2ProteccionCivil ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2Inah')?>:</strong></label></td>
                    <td><?= $model->p2Inah ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2Sepyc')?>:</strong></label></td>
                    <td><?= $model->p2Sepyc ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2Masa')?>:</strong></label></td>
                    <td><?= $model->p2Masa ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2Aeronautica')?>:</strong></label></td>
                    <td><?= $model->p2Aeronautica ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p2Vecinos')?>:</strong></label></td>
                    <td><?= $model->p2Vecinos ?> </td>
                </tr>
                ...
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3ProyectoArquitectonico')?>:</strong></label></td>
                    <td><?= $model->p3ProyectoArquitectonico ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3ImpactoAmbiental')?>:</strong></label></td>
                    <td><?= $model->p3ImpactoAmbiental ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3ImpactoVial')?>:</strong></label></td>
                    <td><?= $model->p3ImpactoVial ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3OpinionBomberos')?>:</strong></label></td>
                    <td><?= $model->p3OpinionBomberos ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3ProteccionCivil')?>:</strong></label></td>
                    <td><?= $model->p3ProteccionCivil ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3Inah')?>:</strong></label></td>
                    <td><?= $model->p3Inah ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3Sepyc')?>:</strong></label></td>
                    <td><?= $model->p3Sepyc ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3Masa')?>:</strong></label></td>
                    <td><?= $model->p3Masa ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3Aeronautica')?>:</strong></label></td>
                    <td><?= $model->p3Aeronautica ?> </td>
                </tr>
                  
                <tr>
                    <td><label><strong><?= $model->getAttributeLabel('p3Vecinos')?>:</strong></label></td>
                    <td><?= $model->p3Vecinos ?> </td>
                </tr>
