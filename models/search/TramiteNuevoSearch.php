...
/**
 * TramiteNuevoSearch represents the model behind the search form about `app\models\TramiteNuevo`.
 */
class TramiteNuevoSearch extends TramiteNuevo
{
    /**
     * @inheritdoc
     */
