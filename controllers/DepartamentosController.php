...
class DepartamentosController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('index', ['model'=>$model,'Departamentos'=>$Departamentos]);
        }
    }

     public function actionCambiar(){

        $model = Departamentos::find()->where('id=:id', ['id'=>$_GET["id"]])->one();
   ...
   /// }
    ...
    // get your HTML raw content without any layouts or scrip
        $Departamentos = Departamentos::find()->all();
        $content=$this->renderPartial('_imprimir',['Departamentos'=>$Departamentos]); 
        $header=$this->renderPartial('_header', ['Departamentos'=>$Departamentos]);
        $pdf = new Pdf([
